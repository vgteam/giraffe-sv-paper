...
Because is uses the genotype of the individuals in the MESA cohort, this step was run on Terra.
The resulting frequencies are saved in a file used later in this report.
