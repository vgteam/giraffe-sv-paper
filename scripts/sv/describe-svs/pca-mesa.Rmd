...
Because it takes about 30 mins and the genotypes cannot be shared for MESA, the principal components were pre-computed on Terra from the allele counts using the following commands:
