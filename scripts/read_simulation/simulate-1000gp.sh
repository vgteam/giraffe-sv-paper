...
echo save files
aws s3 cp sim.gam  s3://vg-k8s/profiling/reads/sim/for-NA19239/1000gp/hs38d1/liftover/${SEQ}/out_sim_gbwt/
aws s3 cp sim.fq.gz  s3://vg-k8s/profiling/reads/sim/for-NA19239/1000gp/hs38d1/liftover/${SEQ}/out_sim_gbwt/
aws s3 cp true.pos  s3://vg-k8s/profiling/reads/sim/for-NA19239/1000gp/hs38d1/liftover/${SEQ}/out_sim_gbwt/
