...
aws s3 cp --quiet s3://vg-k8s/profiling/graphs/v3-2/for-NA19239/1000gp/hs38d1/1000GP_hs38d1_filter.full.gbwt ./graph.gbwt
aws s3 cp --quiet s3://vg-k8s/profiling/graphs/v3-2/for-NA19239/1000gp/hs38d1/1000GP_hs38d1_filter.xg ./graph.xg
aws s3 cp --quiet s3://vg-k8s/profiling/graphs/v3-2/for-NA19239/1000gp/hs38d1/1000GP_hs38d1_filter.vg ./graph.vg

echo simulate reads
vg sim -r -n $NREADS -a -s 12345 -p 570 -v 165 -i 0.00029 -x graph.xg -g graph.gbwt --sample-name NA19239 --ploidy-regex "hs37d5:0,NC_007605:0,X:1,Y:1,chrY_.*:1,chrEBV:0,.*:2" -F $FASTQ > sim.raw.gam
...
echo save files
aws s3 cp sim.gam  s3://vg-k8s/profiling/reads/sim/for-NA19239/1000gp/hs38d1/${SEQ}/out_sim_gbwt/
aws s3 cp sim.fq.gz  s3://vg-k8s/profiling/reads/sim/for-NA19239/1000gp/hs38d1/${SEQ}/out_sim_gbwt/
aws s3 cp true.pos  s3://vg-k8s/profiling/reads/sim/for-NA19239/1000gp/hs38d1/${SEQ}/out_sim_gbwt/
