...
mkdir -p "${READS_DIR}/HG002"
wget_download https://storage.googleapis.com/cmarkell-vg-wdl-dev/test_input_reads/HG002.novaseq.pcr-free.35x.R1.fastq.gz "${READS_DIR}/HG002/HG002.NovaSeq.pcr-free.35x.R1.fastq.gz"
wget_download https://storage.googleapis.com/cmarkell-vg-wdl-dev/test_input_reads/HG002.novaseq.pcr-free.35x.R2.fastq.gz "${READS_DIR}/HG002/HG002.NovaSeq.pcr-free.35x.R2.fastq.gz"
wget_download https://storage.googleapis.com/cmarkell-vg-wdl-dev/test_input_reads/HG002_read_pair_1.fq.gz "${READS_DIR}/HG002/HG002.NovaSeq.250bp.R1.fastq.gz"
wget_download https://storage.googleapis.com/cmarkell-vg-wdl-dev/test_input_reads/HG002_read_pair_2.fq.gz "${READS_DIR}/HG002/HG002.NovaSeq.250bp.R2.fastq.gz"
mkdir -p "${READS_DIR}/HG003"
wget_download https://storage.googleapis.com/cmarkell-vg-wdl-dev/test_input_reads/HG003.novaseq.pcr-free.35x.R1.fastq.gz "${READS_DIR}/HG003/HG003.NovaSeq.pcr-free.35x.R1.fastq.gz"
wget_download https://storage.googleapis.com/cmarkell-vg-wdl-dev/test_input_reads/HG003.novaseq.pcr-free.35x.R2.fastq.gz "${READS_DIR}/HG003/HG003.NovaSeq.pcr-free.35x.R2.fastq.gz"
