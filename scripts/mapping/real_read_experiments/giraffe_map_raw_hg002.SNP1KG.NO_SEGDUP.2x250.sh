...
-p \
-t 100 > giraffe_all_wgs.RAW.1000GP.NO_SEGDUP.HG002.2x250.bam

samtools sort --threads 100 -O BAM giraffe_all_wgs.RAW.1000GP.NO_SEGDUP.HG002.2x250.bam > giraffe_all_wgs.RAW.1000GP.NO_SEGDUP.HG002.2x250.positionsorted.bam && rm giraffe_all_wgs.RAW.1000GP.NO_SEGDUP.HG002.2x250.bam
samtools index -@ 100 giraffe_all_wgs.RAW.1000GP.NO_SEGDUP.HG002.2x250.positionsorted.bam
