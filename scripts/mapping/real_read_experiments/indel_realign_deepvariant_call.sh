...
WORK_DIR=$PWD
SAMPLE_NAME="HG002"
INPUT_BAM="HG002.vg_map_liftover_grch38_nosegdup.2x150bp.bam"
...
TRUTH_VCF="HG002_GRCh38_1_22_v4.2.1_benchmark.xian_adam.vcf.gz" \
TRUTH_BED="HG002_GRCh38_1_22_v4.2.1_benchmark_noinconsistent.xian_adam.bed" \
