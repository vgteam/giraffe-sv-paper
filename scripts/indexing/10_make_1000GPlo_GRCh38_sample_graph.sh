...
# Graphs were actually generated by running toil-vg version
# git+https://github.com/vgteam/toil-vg.git@26d82446915f034f4d9c51165f6a57046d5368c0 and then restarting with
